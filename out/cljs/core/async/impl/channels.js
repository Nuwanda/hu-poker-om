...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19576 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19576 = (function (val,box,meta19577){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19576.cljs$lang$type = true;
cljs.core.async.impl.channels.t19576.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19576";
cljs.core.async.impl.channels.t19576.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"cljs.core.async.impl.channels/t19576");
});
cljs.core.async.impl.channels.t19576.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19576.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19578){var self__ = this;
var _19578__$1 = this;return self__.meta19577;
});
cljs.core.async.impl.channels.t19576.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19578,meta19577__$1){var self__ = this;
var _19578__$1 = this;return (new cljs.core.async.impl.channels.t19576(self__.val,self__.box,meta19577__$1));
});
cljs.core.async.impl.channels.__GT_t19576 = (function __GT_t19576(val__$1,box__$1,meta19577){return (new cljs.core.async.impl.channels.t19576(val__$1,box__$1,meta19577));
});
}
return (new cljs.core.async.impl.channels.t19576(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_19579 = self__.takes.pop();if((taker_19579 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19579))
{var take_cb_19580 = cljs.core.async.impl.protocols.commit.call(null,taker_19579);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19580,taker_19579,this$__$1){
return (function (){return take_cb_19580.call(null,null);
});})(take_cb_19580,taker_19579,this$__$1))
);
} else
{}
{
